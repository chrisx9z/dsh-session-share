window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\deepseek-harness\packages\session-query\session-share\src\client\Dialog.module.css.mjs
		const css$1 = ".LoRCba_content{flex-direction:column;gap:12px;min-height:0;display:flex}.LoRCba_status{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;line-height:20px}.LoRCba_controls{flex-wrap:wrap;align-items:flex-end;gap:12px;display:flex}.LoRCba_rangeControl{color:var(--dsw-alias-label-secondary);flex-direction:column;gap:4px;font-size:13px;display:flex}.LoRCba_rangeControl select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-elevated);max-width:260px;height:28px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);border-radius:6px;font-size:13px}.LoRCba_formatControl{color:var(--dsw-alias-label-secondary);border:none;align-items:center;gap:12px;margin:0;padding:0;font-size:13px;display:flex}.LoRCba_formatControl legend,.LoRCba_optionControl legend{margin-bottom:4px;padding:0}.LoRCba_formatControl label,.LoRCba_optionControl label{cursor:pointer;align-items:center;gap:4px;display:inline-flex}.LoRCba_optionControl{color:var(--dsw-alias-label-secondary);border:none;flex-direction:column;gap:6px;margin:0;padding:0;font-size:13px;display:flex}.LoRCba_messagesHeading{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px}.LoRCba_list{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;max-height:220px;margin:0;padding:0;list-style:none;overflow-y:auto}.LoRCba_row{width:100%;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);text-align:left;cursor:pointer;background:0 0;border:none;align-items:center;gap:8px;padding:6px 10px;font-size:13px;line-height:20px;display:flex}.LoRCba_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.LoRCba_rowSelected{background:var(--dsw-alias-interactive-bg-active)}.LoRCba_rowIndex{color:var(--dsw-alias-label-dimmed);font-variant-numeric:tabular-nums;flex:none}.LoRCba_rowCheck{text-align:center;width:14px;color:var(--dsw-alias-label-primary);flex:none;font-size:12px}.LoRCba_rowRole{flex:none;font-weight:600}.LoRCba_rowTool{color:var(--dsw-alias-label-dimmed);font-weight:400}.LoRCba_rowTime{color:var(--dsw-alias-label-dimmed);flex:none;font-size:12px}.LoRCba_rowText{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-secondary);overflow:hidden}.LoRCba_preview{color:var(--dsw-alias-label-secondary);font-size:13px}.LoRCba_preview summary{cursor:pointer;user-select:none}.LoRCba_previewBody{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-elevated);max-height:240px;color:var(--dsw-alias-label-primary);word-break:break-word;border-radius:8px;margin:8px 0 0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.LoRCba_previewRow{margin:8px 0}.LoRCba_previewRow:first-child{margin-top:0}.LoRCba_previewRole{color:var(--dsw-alias-label-secondary);margin-bottom:2px;font-size:12px;font-weight:600;display:block}";
		const tagId$1 = "dsh-session-share/Dialog.module.css";
		...
		var Dialog_module_css_default = {
			"content": "LoRCba_content",
			"controls": "LoRCba_controls",
			"formatControl": "LoRCba_formatControl",
			"list": "LoRCba_list",
			"messagesHeading": "LoRCba_messagesHeading",
			"optionControl": "LoRCba_optionControl",
			"preview": "LoRCba_preview",
			"previewBody": "LoRCba_previewBody",
			"previewRole": "LoRCba_previewRole",
			"previewRow": "LoRCba_previewRow",
			"rangeControl": "LoRCba_rangeControl",
			"row": "LoRCba_row",
			"rowCheck": "LoRCba_rowCheck",
			"rowIndex": "LoRCba_rowIndex",
			"rowRole": "LoRCba_rowRole",
			"rowSelected": "LoRCba_rowSelected",
			"rowText": "LoRCba_rowText",
			"rowTime": "LoRCba_rowTime",
			"rowTool": "LoRCba_rowTool",
			"status": "LoRCba_status"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\deepseek-harness\packages\session-query\session-share\src\client\HeaderAction.module.css.mjs
		const css = ".yK5vCW_shareButton{border:1px solid var(--dsw-alias-border-l2);min-width:96px;height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:4px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}.yK5vCW_shareButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.yK5vCW_shareButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:wait}.yK5vCW_shareButton span,.yK5vCW_shareButton svg{flex:none}.yK5vCW_shareButton span{white-space:nowrap}";
		const tagId = "dsh-session-share/HeaderAction.module.css";
		...
		var HeaderAction_module_css_default = { "shareButton": "yK5vCW_shareButton" };
		//#endregion
		...
		*/
		function apply(ctx) {
			...
			}, "session-share: browser lifecycle");
			ctx.effect(() => ctx.locale.register(NS, {
				zh,
				en
			}), "session-share: browser dictionaries");
